...
contract SimpleSwapAddLiquidityTest is SimpleSwapSetUp {
    ...
    function test_addLiquidity() public {
        ...
        assertEq(tokenB.balanceOf(maker), 1000 * 10 ** tokenBDecimals - amountB);
...
contract SimpleSwapAddLiquidityAfterInitial is SimpleSwapSetUp {
    //     uint256 public reserveAAfterFirstAddLiquidity;
    //     uint256 public reserveBAfterFirstAddLiquidity;
    //     function setUp() public override {
    //         super.setUp();
    ...
    //         simpleSwap.addLiquidity(amountA, amountB);
    //         assertEq(tokenA.balanceOf(maker), makerBalanceABefore - amountA);
    //         assertEq(tokenB.balanceOf(maker), makerBalanceBBefore - actualAmountB);
    //         assertEq(tokenA.balanceOf(address(simpleSwap)), simpleSwapBalanceABefore + amountA);
    ...
    //         simpleSwap.addLiquidity(amountA, amountB);
    //         assertEq(tokenA.balanceOf(maker), makerBalanceABefore - actualAmountA);
    //         assertEq(tokenB.balanceOf(maker), makerBalanceBBefore - amountB);
